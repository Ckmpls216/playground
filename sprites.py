...
class Spritesheet:
    def __init__(self, file):
        try:
            ...
            raise SystemExit(f"Unable to load spritesheet image: {file}. Pygame said: {e}")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.max_travel = random.randint(7, 32)
...
class Button:
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        self.font = pygame.font.Font('gameFont_1.ttf', fontsize)
